...
Elsevier, the world's largest publisher of scientific articles, just [cut off access](https://www.latimes.com/business/hiltzik/la-fi-uc-elsevier-20190711-story.html) to its journals by the University of California, one of the world's largest producers of scientific articles, because UC objected to Elsevier's increasingly exorbitant subscription fees. Meanwhile, many funders of scientific research, mostly in Europe but also including the Gates Foundation, have signed on to [Plan S](https://en.wikipedia.org/wiki/Plan_S), which stipulates that research that is funded with money from supporting institutions must be published in open access journals or platforms.
