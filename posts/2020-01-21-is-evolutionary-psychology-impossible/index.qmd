...
Although not acknowledged by Smith, evolutionary psychologists emphasize the importance of comparative data, including both homologies and analogies (see @fig-schmitt).


```{r fig-schmitt, echo=F, fig.align='center', fig.cap="Schematic representation of the different forms of evidence used to evaluate the validity of psychological adaptations. AI: artificial intelligence. Figure and caption from Schmitt and Pilcher (2004)."}
knitr::include_graphics("SchmittPilcher.png")
```
...
```{r fig-vonk, echo=F, fig.align='center', fig.cap="Oxford Handbook of Comparative Evolutionary Psychology, Vonk & Shackelford, Eds. (2012)."}
knitr::include_graphics("ComparativeEP.png")
```
